...
export type Mutation = {
  __typename?: 'Mutation';
  registerNewBook?: Maybe<Book>;
};


export type MutationRegisterNewBookArgs = {
  authorBirthYear?: InputMaybe<Scalars['Int']['input']>;
...
export type MutationResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  registerNewBook?: Resolver<Maybe<ResolversTypes['Book']>, ParentType, ContextType, RequireFields<MutationRegisterNewBookArgs, 'authorName' | 'title'>>;
};

export type QueryResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  bookByTitle?: Resolver<Maybe<ResolversTypes['Book']>, ParentType, ContextType, RequireFields<QueryBookByTitleArgs, 'title'>>;
